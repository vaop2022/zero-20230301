...
def setup(va):
    ...
    va.defineVariable('The max number of the v-agent jump. It is for prevent looping...p11', 10000)
    ...
    va.defineVariable('The current Action...current action', 'Action__init') 
